<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="modal_politica" >
        ...
        <div class="modal-content col-12">
            ...
            <div class="modal-body text-left">
                @if (isset($informacio))
                    ...
                    <h1>2. Recogida, finalidad y tratamientos de datos</h1>
                    ...
                    <h1>3. Comunicación de información a terceros</h1>
                    ...
                    <h1>4. Derechos de los usuarios</h1>
