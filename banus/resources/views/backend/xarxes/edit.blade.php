...
@section('content')
    ...
    <form action="{{route('xarxes.update',['id' => $xarxa->id])}}" method="POST" id="formXarxa">
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" name="nom" value="{{ $xarxa->nom }}" id="nomXarxa" >
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" name="icona" value="{{ $xarxa->icona }}" id="iconaXarxa">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" name="enllac" value="{{ $xarxa->enllac }}" id="enllac">
            </div>
        </div>
        <div class="row">
